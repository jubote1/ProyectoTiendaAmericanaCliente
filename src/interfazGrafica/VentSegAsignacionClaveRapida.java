	...
	public VentSegAsignacionClaveRapida(java.awt.Frame parent, Usuario usuario,  boolean modal) {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			}else if(segundoIntento)
			{
				...
				{
					//Se tuvo error y ambas contaseñas no coinciden
					JOptionPane.showMessageDialog(ventanaPadre, "La confirmación de clave rápida no coincide con la inicialmente ingresada, \n por favor repita el proceso", "Renovación de clave rápida", JOptionPane.ERROR_MESSAGE);
					valorPrimerIntento  = "";
					valorSegIntento = "";
					primerIntento = true;
