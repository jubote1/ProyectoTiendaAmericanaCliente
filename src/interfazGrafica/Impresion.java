   ...
   public static void main (String impresion)
   {
	 ...
	 //Cogemos el servicio de impresi贸n por defecto (impresora por defecto)
	   ...
	   //catch (PrintException e) {
		 ...
		 correo.setAsunto("ERROR IMPRESI覰 TIENDA " + tienda.getNombretienda() + " " + fecha.toString());
		 correo.setContrasena("Pizzaamericana2017");
		 correo.setUsuarioCorreo("alertaspizzaamericana@gmail.com");
		 correo.setMensaje("En este momento existen problemas de impresi髇 en la tienda " + tienda.getNombretienda() + "\n" + e.toString());
...
//	   try {
//		 //Cuando se cambie el m閠odo a cortecaja se debe quitar esto
