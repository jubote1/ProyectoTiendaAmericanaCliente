...
public class VentCRUDParametrosDireccion extends JFrame {
	...
	public VentCRUDParametrosDireccion() {
		...
		setBounds((ancho / 2) - (this.getWidth() / 2), (alto / 2) - (this.getHeight() / 2), 617, 474);
