 ...
 *
 */
public class AccesosPorMenuDAO {
 ...
 */
	public static ArrayList obtenerAccesosPorMenu(boolean auditoria)
	{
		Logger logger = Logger.getLogger("log_file");
		ConexionBaseDatos con = new ConexionBaseDatos();
		Connection con1 = con.obtenerConexionBDLocal();
		ArrayList accesosPorMenu = new ArrayList();
		try
		{
			Statement stm = con1.createStatement();
			String consulta = "select a.idaccesomenu, b.descripcion, c.menu_agrupador from accesos_por_menu a, tipo_empleado b, agrupador_menu c where a.idtipoempleado = b.idtipoempleado and a.idagrupadormenu = c.idmenuagrupador";
	 ...
	 * @return
	 */
	public static ArrayList<AccesosPorMenu> obtenerAccesosPorMenuObj(boolean auditoria)
	{
		Logger logger = Logger.getLogger("log_file");
		ConexionBaseDatos con = new ConexionBaseDatos();
		Connection con1 = con.obtenerConexionBDLocal();
		...
		{
			Statement stm = con1.createStatement();
			String consulta = "select * from accesos_por_menu";
			if(auditoria)
			{
				logger.info(consulta);
			}
